...
plt.legend()
plt.savefig('List_3_zad_5.png', dpi=300)
plt.show()
...
plt.legend()
plt.savefig('List_3_zad_5_z.png', dpi=300)
plt.show()
...
plt.title('Wykres sezonowy')
plt.legend()
plt.savefig('List_3_zad_8_5.png', dpi=300)
plt.show()
...
plt.title('Wykres sezonowy zbliżenie')
plt.legend()
plt.savefig('List_3_zad_8_5_z.png', dpi=300)
plt.show()
